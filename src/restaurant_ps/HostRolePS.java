...
import restaurant_ps.gui.HostGuiPS;
...
public class HostRolePS extends Role implements Host{
	...
	public void msgIsActive() {
		...
		getPersonAgent().getRestaurant(5).isClosed = false;
	...
	private void closeRestaurant() {
		getPersonAgent().getRestaurant(5).isClosed = true;
	...
	public void setCashier(Cashier c) {
		cashier = c;
		if(!workers.contains(((CashierRolePS)cashier).getPersonAgent())) workers.add(((CashierRolePS)cashier).getPersonAgent());
	}
	...
	public void setCook(Cook c) {
		cook = c;
		if(!workers.contains(((CookRolePS)cook).getPersonAgent())) workers.add(((CookRolePS)cook).getPersonAgent());
	}
	...
	public void setGui(HostGuiPS gui) {
		hostGui = gui;
	}

	public HostGuiPS getGui() {
		return hostGui;
	}
