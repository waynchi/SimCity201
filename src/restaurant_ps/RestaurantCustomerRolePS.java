...
//		}
		this.restGui = gui;
		customerGui = new CustomerGuiPS(this);
	 ...
	 */
	public void setHost(HostRolePS host) {
		this.host = host;
	}
	...
	private void payCheck() {
		...
		((CashierRolePS) cashier).msgPayMyCheck(this, getPersonAgent().getMoney());
	...
	public void setGui(CustomerGuiPS g) {
		customerGui = g;
	}

	public CustomerGuiPS getGui() {
		return customerGui;
	}
