 ...
 */
public class RestaurantGuiPS extends JPanel implements ActionListener {
    /* The GUI has only one frame and two panels within, the control panel 
     * and the animation panel
     */
	public static RestaurantAnimationPanelPS animationPanel;
    
    public static List<CustomerGuiPS> customers = new ArrayList<CustomerGuiPS>();
    ...
    public RestaurantGuiPS(Timer timer) {
        ...
        animationPanel = new RestaurantAnimationPanelPS(timer);
    ...
    */
    public RestaurantAnimationPanelPS getAnimationPanel(){
